...
## ViType – Được xây dựng từ nhu cầu sử dụng thực tế
...
🔗 Mã nguồn được public tại: [https://github.com/ttdatt/vitype](https://github.com/ttdatt/vitype)

## Một vài điểm nổi bật của ViType

### Tự động loại trừ ứng dụng (exclude app)

ViType cho phép loại trừ các ứng dụng như IDE, terminal hoặc trình soạn thảo mã. Khi người dùng vừa nhắn tin và chuyển ngay sang Visual Studio Code để code, trình gõ sẽ tự động không áp dụng bộ gõ tiếng Việt, không cần thao tác thủ công.

### Hỗ trợ người dùng đa ngôn ngữ

Trên macOS, khi chuyển sang bàn phím tiếng Trung, ViType có thể tự động ngừng bỏ dấu tiếng Việt, giúp việc nhập liệu giữa nhiều ngôn ngữ trở nên liền mạch hơn.

### Mã nguồn mở & minh bạch

Toàn bộ mã nguồn được công khai, cho phép cộng đồng cùng kiểm tra, đóng góp và cải tiến theo thời gian.

## Cùng dùng thử và xây dựng ViType

ViType vẫn đang trong quá trình hoàn thiện và rất mong nhận được phản hồi từ người dùng để ngày càng tốt hơn. Nếu bạn đang tìm kiếm một trình gõ tiếng Việt phù hợp cho công việc hàng ngày, đặc biệt là khi phải chuyển đổi liên tục giữa nhiều ứng dụng, ViType rất mong có cơ hội được đồng hành.
